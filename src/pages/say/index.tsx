...
const renderItem = [
  ...
  },
  {
    ...
    introducemd:
      "博客同时启用HTTPS、HTTP(更新优先)双协议访问，由近期驾照学习，本博客暂停更新，如有不便敬请见谅",
    showDate: "2020-05-12",
    selectedType: "生活分享",
    sourceType: "秃头日记",
    fire: 1,
  },
  {
    ...
    articleTitle: "重构博客样式",
    introducemd:
      "redux重构博客样式，点击或触碰头像实现风格转换，集成互动页邮件通知，重构生活页，持续制作中。。。",
    showDate: "2020-04-23",
    selectedType: "生活分享",
    sourceType: "秃头日记",
    fire: 3,
  ...
  },
  {
    ...
    introducemd:
      "博客前后台新添互动页面，前台含播放器与留言功能，后台增添互动页评论管理。",
    showDate: "2020-04-17",
    selectedType: "生活分享",
    sourceType: "秃头日记",
    fire: 1,
                          ...
                          <div className="bacophover">
                            <div className="bacimg-title">
                              <Paragraph ellipsis style={{ color: "#fff" }}>
                                ...
                                <span style={{ textShadow: "0 0 8px #fff" }}>
                                  {item.articleTitle}
                                </span>
                              </Paragraph>
                            </div>
